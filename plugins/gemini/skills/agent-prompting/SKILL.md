...
description: Internal guidance for composing structured prompts for coding, review, diagnosis, and research tasks inside the Gemini Claude Code plugin
user-invocable: false
---

# Agent Prompting

Use this skill when `gemini:gemini-rescue` needs to ask Gemini CLI or another AI-based workflow for help.
